...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20010', 'model/InlineResponse2018', 'model/InlineResponse400', 'model/ProductForm', 'model/ProductForm1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse20010'), require('../model/InlineResponse2018'), require('../model/InlineResponse400'), require('../model/ProductForm'), require('../model/ProductForm1'));
  } else {
    // Browser globals (root is window)
    if (!root.Parasut) {
      root.Parasut = {};
    }
    root.Parasut.ProductsApi = factory(root.Parasut.ApiClient, root.Parasut.InlineResponse20010, root.Parasut.InlineResponse2018, root.Parasut.InlineResponse400, root.Parasut.ProductForm, root.Parasut.ProductForm1);
  }
}(this, function(ApiClient, InlineResponse20010, InlineResponse2018, InlineResponse400, ProductForm, ProductForm1) {
  'use strict';
