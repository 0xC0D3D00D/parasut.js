...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20014', 'model/InlineResponse20112', 'model/InlineResponse400', 'model/ShipmentDocumentForm', 'model/ShipmentDocumentForm1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse20014'), require('../model/InlineResponse20112'), require('../model/InlineResponse400'), require('../model/ShipmentDocumentForm'), require('../model/ShipmentDocumentForm1'));
  } else {
    // Browser globals (root is window)
    if (!root.Parasut) {
      root.Parasut = {};
    }
    root.Parasut.ShipmentDocumentsApi = factory(root.Parasut.ApiClient, root.Parasut.InlineResponse20014, root.Parasut.InlineResponse20112, root.Parasut.InlineResponse400, root.Parasut.ShipmentDocumentForm, root.Parasut.ShipmentDocumentForm1);
  }
}(this, function(ApiClient, InlineResponse20014, InlineResponse20112, InlineResponse400, ShipmentDocumentForm, ShipmentDocumentForm1) {
  'use strict';
