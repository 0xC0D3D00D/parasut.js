...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20011', 'model/InlineResponse2013', 'model/InlineResponse2019', 'model/InlineResponse400', 'model/PaymentForm1', 'model/PurchaseBillForm', 'model/PurchaseBillForm1', 'model/PurchaseBillForm2', 'model/PurchaseBillForm3'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse20011'), require('../model/InlineResponse2013'), require('../model/InlineResponse2019'), require('../model/InlineResponse400'), require('../model/PaymentForm1'), require('../model/PurchaseBillForm'), require('../model/PurchaseBillForm1'), require('../model/PurchaseBillForm2'), require('../model/PurchaseBillForm3'));
  } else {
    // Browser globals (root is window)
    if (!root.Parasut) {
      root.Parasut = {};
    }
    root.Parasut.PurchaseBillsApi = factory(root.Parasut.ApiClient, root.Parasut.InlineResponse20011, root.Parasut.InlineResponse2013, root.Parasut.InlineResponse2019, root.Parasut.InlineResponse400, root.Parasut.PaymentForm1, root.Parasut.PurchaseBillForm, root.Parasut.PurchaseBillForm1, root.Parasut.PurchaseBillForm2, root.Parasut.PurchaseBillForm3);
  }
}(this, function(ApiClient, InlineResponse20011, InlineResponse2013, InlineResponse2019, InlineResponse400, PaymentForm1, PurchaseBillForm, PurchaseBillForm1, PurchaseBillForm2, PurchaseBillForm3) {
  'use strict';
