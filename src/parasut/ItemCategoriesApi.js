...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2009', 'model/InlineResponse2017', 'model/InlineResponse400', 'model/ItemCategoryForm', 'model/ItemCategoryForm1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse2009'), require('../model/InlineResponse2017'), require('../model/InlineResponse400'), require('../model/ItemCategoryForm'), require('../model/ItemCategoryForm1'));
  } else {
    // Browser globals (root is window)
    if (!root.Parasut) {
      root.Parasut = {};
    }
    root.Parasut.ItemCategoriesApi = factory(root.Parasut.ApiClient, root.Parasut.InlineResponse2009, root.Parasut.InlineResponse2017, root.Parasut.InlineResponse400, root.Parasut.ItemCategoryForm, root.Parasut.ItemCategoryForm1);
  }
}(this, function(ApiClient, InlineResponse2009, InlineResponse2017, InlineResponse400, ItemCategoryForm, ItemCategoryForm1) {
  'use strict';
