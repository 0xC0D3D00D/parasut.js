...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20015', 'model/InlineResponse400'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse20015'), require('../model/InlineResponse400'));
  } else {
    // Browser globals (root is window)
    if (!root.Parasut) {
      root.Parasut = {};
    }
    root.Parasut.StockMovementsApi = factory(root.Parasut.ApiClient, root.Parasut.InlineResponse20015, root.Parasut.InlineResponse400);
  }
}(this, function(ApiClient, InlineResponse20015, InlineResponse400) {
  'use strict';
