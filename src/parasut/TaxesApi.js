...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20017', 'model/InlineResponse20114', 'model/InlineResponse2013', 'model/InlineResponse400', 'model/PaymentForm4', 'model/TaxForm', 'model/TaxForm1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse20017'), require('../model/InlineResponse20114'), require('../model/InlineResponse2013'), require('../model/InlineResponse400'), require('../model/PaymentForm4'), require('../model/TaxForm'), require('../model/TaxForm1'));
  } else {
    // Browser globals (root is window)
    if (!root.Parasut) {
      root.Parasut = {};
    }
    root.Parasut.TaxesApi = factory(root.Parasut.ApiClient, root.Parasut.InlineResponse20017, root.Parasut.InlineResponse20114, root.Parasut.InlineResponse2013, root.Parasut.InlineResponse400, root.Parasut.PaymentForm4, root.Parasut.TaxForm, root.Parasut.TaxForm1);
  }
}(this, function(ApiClient, InlineResponse20017, InlineResponse20114, InlineResponse2013, InlineResponse400, PaymentForm4, TaxForm, TaxForm1) {
  'use strict';
