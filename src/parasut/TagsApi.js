...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20016', 'model/InlineResponse20113', 'model/InlineResponse400', 'model/TagForm', 'model/TagForm1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse20016'), require('../model/InlineResponse20113'), require('../model/InlineResponse400'), require('../model/TagForm'), require('../model/TagForm1'));
  } else {
    // Browser globals (root is window)
    if (!root.Parasut) {
      root.Parasut = {};
    }
    root.Parasut.TagsApi = factory(root.Parasut.ApiClient, root.Parasut.InlineResponse20016, root.Parasut.InlineResponse20113, root.Parasut.InlineResponse400, root.Parasut.TagForm, root.Parasut.TagForm1);
  }
}(this, function(ApiClient, InlineResponse20016, InlineResponse20113, InlineResponse400, TagForm, TagForm1) {
  'use strict';
