...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EmployeeForm', 'model/EmployeeForm1', 'model/InlineResponse2008', 'model/InlineResponse2016', 'model/InlineResponse400'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/EmployeeForm'), require('../model/EmployeeForm1'), require('../model/InlineResponse2008'), require('../model/InlineResponse2016'), require('../model/InlineResponse400'));
  } else {
    // Browser globals (root is window)
    if (!root.Parasut) {
      root.Parasut = {};
    }
    root.Parasut.EmployeesApi = factory(root.Parasut.ApiClient, root.Parasut.EmployeeForm, root.Parasut.EmployeeForm1, root.Parasut.InlineResponse2008, root.Parasut.InlineResponse2016, root.Parasut.InlineResponse400);
  }
}(this, function(ApiClient, EmployeeForm, EmployeeForm1, InlineResponse2008, InlineResponse2016, InlineResponse400) {
  'use strict';
