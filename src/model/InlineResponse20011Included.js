...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Parasut.InlineResponse20011Included = factory(root.Parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse20011Included model module.
   * @module model/InlineResponse20011Included
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>InlineResponse20011Included</code>.
   * @alias module:model/InlineResponse20011Included
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20011Included</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20011Included} obj Optional instance to populate.
   * @return {module:model/InlineResponse20011Included} The populated <code>InlineResponse20011Included</code> instance.
   */
   ...
   * @member {module:model/InlineResponse20011Included.TypeEnum} type
   */
