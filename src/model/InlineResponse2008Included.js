...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Parasut.InlineResponse2008Included = factory(root.Parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse2008Included model module.
   * @module model/InlineResponse2008Included
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>InlineResponse2008Included</code>.
   * @alias module:model/InlineResponse2008Included
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2008Included</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2008Included} obj Optional instance to populate.
   * @return {module:model/InlineResponse2008Included} The populated <code>InlineResponse2008Included</code> instance.
   */
   ...
   * @member {module:model/InlineResponse2008Included.TypeEnum} type
   */
