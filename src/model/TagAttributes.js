...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Parasut.TagAttributes = factory(root.Parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TagAttributes model module.
   * @module model/TagAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>TagAttributes</code>.
   * @alias module:model/TagAttributes
   * @class
   * @param name {String} Etiket adı
   */
  ...
  /**
   * Constructs a <code>TagAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TagAttributes} obj Optional instance to populate.
   * @return {module:model/TagAttributes} The populated <code>TagAttributes</code> instance.
   */
