...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdbankFeesDataRelationshipsCategory', 'model/CompanyIdbankFeesDataRelationshipsTags', 'model/CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee', 'model/CompanyIdpurchaseBillsbasicDataRelationshipsSupplier', 'model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdbankFeesDataRelationshipsCategory'), require('./CompanyIdbankFeesDataRelationshipsTags'), require('./CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee'), require('./CompanyIdpurchaseBillsbasicDataRelationshipsSupplier'), require('./CompanyIdpurchaseBillsdetailedDataRelationshipsDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.Parasut) {
      root.Parasut = {};
    }
    root.Parasut.CompanyIdpurchaseBillsdetailedDataRelationships = factory(root.Parasut.ApiClient, root.Parasut.CompanyIdbankFeesDataRelationshipsCategory, root.Parasut.CompanyIdbankFeesDataRelationshipsTags, root.Parasut.CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee, root.Parasut.CompanyIdpurchaseBillsbasicDataRelationshipsSupplier, root.Parasut.CompanyIdpurchaseBillsdetailedDataRelationshipsDetails);
  }
}(this, function(ApiClient, CompanyIdbankFeesDataRelationshipsCategory, CompanyIdbankFeesDataRelationshipsTags, CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee, CompanyIdpurchaseBillsbasicDataRelationshipsSupplier, CompanyIdpurchaseBillsdetailedDataRelationshipsDetails) {
  'use strict';

  /**
   * The CompanyIdpurchaseBillsdetailedDataRelationships model module.
   * @module model/CompanyIdpurchaseBillsdetailedDataRelationships
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdpurchaseBillsdetailedDataRelationships</code>.
   * @alias module:model/CompanyIdpurchaseBillsdetailedDataRelationships
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdpurchaseBillsdetailedDataRelationships</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdpurchaseBillsdetailedDataRelationships} obj Optional instance to populate.
   * @return {module:model/CompanyIdpurchaseBillsdetailedDataRelationships} The populated <code>CompanyIdpurchaseBillsdetailedDataRelationships</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('details'))
        obj.details = CompanyIdpurchaseBillsdetailedDataRelationshipsDetails.constructFromObject(data['details']);
      ...
      if (data.hasOwnProperty('paid_by_employee'))
        obj.paidByEmployee = CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee.constructFromObject(data['paid_by_employee']);
  ...
  /**
   * @member {module:model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetails} details
   */
  ...
  /**
   * @member {module:model/CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee} paidByEmployee
   */
  exports.prototype.paidByEmployee = undefined;
